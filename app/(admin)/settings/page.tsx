...
const AI_CONFIGS = [
  {
    ...
    placeholder: 'AIzaSy...',
    link: 'https://aistudio.google.com/app/apikey', linkText: 'Google AI Studio',
  ...
  },
  {
    ...
    badge: '무료', badgeColor: '#22c55e',
    placeholder: 'gsk_...',
    link: 'https://console.groq.com/keys', linkText: 'Groq Console',
    desc: '매우 빠른 속도의 AI예요. 무료로 사용할 수 있어요.',
    usage: 'Gemini 오류 시 자동으로 대체 사용해요.',
    quality: '⭐⭐⭐⭐ 무료',
  },
  {
    key: 'openai', label: 'OpenAI API Key (GPT-4o)', icon: '🤖',
    badge: '유료', badgeColor: '#f59e0b',
    placeholder: 'sk-...',
    link: 'https://platform.openai.com/api-keys', linkText: 'OpenAI Platform',
    desc: 'ChatGPT 만든 회사의 AI예요. 유료지만 품질이 가장 좋아요.',
    usage: '가장 정확하고 자연스러운 글이 필요할 때 사용해요.',
    quality: '⭐⭐⭐⭐⭐ 유료',
  },
  {
    ...
    link: 'https://pollinations.ai', linkText: 'Pollinations 사이트',
    desc: '텍스트로 이미지를 자동 생성해요. 키 없이 무료로 사용해요.',
    usage: '랜딩페이지 이미지 자동 생성에 사용해요. 퀄리티가 다소 낮을 수 있어요.',
    quality: '⭐⭐⭐ 무료 · 키 불필요',
    noKey: true,
  },
  {
    key: 'dalle', label: 'DALL-E API Key (고퀄 이미지)', icon: '🖼️',
    badge: '유료 · 고퀄리티', badgeColor: '#f59e0b',
    placeholder: 'sk-... (OpenAI 키와 동일해요)',
    link: 'https://platform.openai.com/api-keys', linkText: 'OpenAI Platform',
    desc: 'OpenAI의 이미지 생성 AI예요. 유료지만 퀄리티가 뛰어나요.',
    usage: '고품질 랜딩페이지 이미지 생성에 사용해요.',
    quality: '⭐⭐⭐⭐⭐ 유료',
  },
]
